...
% $Id: spm_csd_demo.m 4402 2011-07-21 12:37:24Z karl $
 function dataname=mln_generate_nmm_vcs_fs(is,nc,strfile,dirname,prename,mincs,maxcs,N,nl,fs) 
...
for  i = 1:size(Astru,2)
    ics=randi([floor(mincs*Ntimes) floor(maxcs*Ntimes)])/Ntimes;
    P.A{1}(Astru(1,i),Astru(2,i)) = ics;
end
