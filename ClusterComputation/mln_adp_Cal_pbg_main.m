function mln_adp_Cal_pbg_main(dirname,prenom,wins,inwins,parafile)
% Calculate the connectivity from MULAN algorithm based on the optimal
% parameters
%dirname='/Users/huifangwang/MULANa/mlnData/N20CS8S50/';
%prenom = 'nmmN20L15CS80100S49N5100.mat';
wins=num2str(1500);
inwins=num2str(-1);
