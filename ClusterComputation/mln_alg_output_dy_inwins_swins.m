function outputname=mln_alg_output_dy_inwins_swins(dir,prenom,threshold1,threshold2,kforMF,Fthreshold,nboot,nboot2,BMG,inwins,add,imlnwins)
...
outputname=['Sta_',prenom,add,'mlnW_',num2str(imlnwins),'.mat'];
...
if ~exist(savestatisfile,'file')
    ...
    if nargin<10
        ...
        Nmln=Nwins/inwins;
        Setlist=(imlnwins-1)*inwins+1:imlnwins*inwins;
    ...
    % read all used methods
        ...
        for img=1:NmethodG
            ...
            InputMM=mln_GenerateTDM_win_dy(MatA,methodlog,nboot,nboot2,Setlist);% here Setlist is the number of windows[1,2,3]
