function mln_Cal_MULAN_fs_mlnvcs_wins_MG2(dirname,prenom,flagTF,flagData,wins)
...
% 
% Examples:mln_Cal_MULAN_fs_mlnvcs_wins_MG2 Examples nmmN20L10CS80100S1N8100 F M 800
% -------------------------------------------------------------------------
...
dataname=[wins,'_',dataname];
Nwins=1:10;
mln_alg_output_wins(dirname,dataname,th1,th2,kforMF,Fthreshold,nboot,nboot2,BMG,Nwins);
end