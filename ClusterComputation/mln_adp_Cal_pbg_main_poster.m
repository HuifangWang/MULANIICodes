function mln_adp_Cal_pbg_main_poster(dirname,prenom,wins,inwins,parafile)
...
%% for parameters obtained from the datasets with few links
%wins=num2str(1500);
 %inwins=num2str(-1);
 %dirname='/Users/huifangwang/MULANa/SeegData/PS1001/';
 %parafile=[dirname,'opt_para_FRN30CS1L35.mat'];
 %prenom = 'WB_PS1001WI041222014ts0ds4.mat';



%% for parameters obtained from the datasets with few links for hidden nodes
%wins=num2str(1500);
%inwins=num2str(-1);
%dirname='/Users/huifangwang/MULANa/SeegData/PS1001/hidNode/';
%parafile=[dirname,'opt_para_FRN_hidden30CS1L35.mat'];
%is=1;
%prenom = ['WB_Hd',num2str(is),'PS1001WI041222014ts0ds4.mat'];
...
%parafile=[dirname,'opt_para_FRN30CS1L35.mat'];
%is=3;
%prenom = ['ND',num2str(is),'_PS1001WI041222014ts200ds4.mat'];
