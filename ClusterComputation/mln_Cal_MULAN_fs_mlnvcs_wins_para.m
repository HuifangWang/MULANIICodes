function mln_Cal_MULAN_fs_mlnvcs_wins_para(dirname,prenom,flagTF,flagData,wins)
...
% 
% Examples:mln_Cal_MULAN_fs_mlnvcs_wins_para Examples nmmN20L10CS80100S1N8100 T M 800
% -------------------------------------------------------------------------
...
VGroupMethlog={'TimeBasic','FreqAH','FreqBasic'};
%VGroupMethlog={'TE'};
...
calParams.defmodelorders=10;
calParams.minfreq=1;
calParams.maxfreq=60;
calParams.stepfreq=1;
calParams.defMaxDelay=50;%50 for cluster
