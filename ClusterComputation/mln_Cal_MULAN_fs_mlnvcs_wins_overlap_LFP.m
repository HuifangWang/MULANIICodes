function mln_Cal_MULAN_fs_mlnvcs_wins_overlap_LFP(dirname,prenom,flagTF,flagData,wins,overlap,inwins)
...
% 
% Examples:mln_Cal_MULAN_fs_mlnvcs_wins_overlap_LFP
% /Users/huifangwang/MULAN3/mlnData/LFP/SlowTheta/ 20130516_CTRds2.mat F R
% 2500 0 3
% -------------------------------------------------------------------------
...
mln_alg_output_dy_inwins(dirname,dataname,th1,th2,kforMF,Fthreshold,nboot,nboot2,BMG,inwins,add);
end
