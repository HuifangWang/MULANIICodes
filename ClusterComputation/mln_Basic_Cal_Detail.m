...
function mln_Basic_Cal_Detail(dirname,dataprenom,calParams,VGroupMethlog,add)
% Huifang Wang, Marseille, August 18, 2013, Calculate all methods  
% Huifang Wang, Feb 5, 2015
...
if exist(datafile,'file')
        try 
            ...
            if isstruct(prevar)
                ...
                iLFP=strncmpi(fileprevar,'Data',3);
                if ~isempty(find(strncmpi(fileprevar,'Data',1)==1,1))
...
for igroup=1:Ngroup
    ...
    Resultfile=[dirname,'/Results/',GroupMethlog,'_',add,'_',dataprenom,'.mat'];
