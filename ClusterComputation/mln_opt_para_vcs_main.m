function mln_opt_para_vcs_main(dirname,filedata,wins)
%%@huifang Aug 23, varying cs
...
para.rangeMax=[0.9,0.9,0.9,0.9,0.5,0.5,0.5,0.5,1,0.9];ls
fitness={'AUCOS'};
...
mln_opt_para_vcs(traindatafile,para,methodlog,savefilefit);
end
