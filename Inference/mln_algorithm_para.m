% Huifang Wang, forward solution for given parameters

function [MatNet,istep]=mln_algorithm_para(MisInput,para,kforMF,methodlog)
%load('Mis_nmm1.mat','MisInput');
Fthreshold=para.pc(strcmp(para.name,'thm'));
data=MisInput;
numMFs=2;
inmftype='gbellmf';
outmftype='constant';
fis=mln_initialfis(data,methodlog,numMFs, inmftype, outmftype,para,kforMF);
