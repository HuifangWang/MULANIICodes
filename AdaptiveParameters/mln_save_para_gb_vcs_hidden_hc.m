function mln_save_para_gb_vcs_hidden_hc()
...
for ibgv=1:length(bgv)
    ...
    for indBG =1:length(BG)
        ...
        savefilename=[basicdir,'opt_para_FRN_hidden',num2str(nc),'b',num2str(bgv(ibgv,1)),num2str(bgv(ibgv,2)),'.mat'];
