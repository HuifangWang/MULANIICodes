...
function [iMat,MatRef,istep,Sim,auc]=mln_Stat_Validation(dir,prenom,threshold,kforMF,Fthreshold,nboot,nboot2,BM)
%Nchan=5;
%dir='/Volumes/HWMac1/MULAN2/SPM/vnERP30GCBTED/ToutResults/';
%dir='/Users/huifangwang/MULANII/programs/';
%prenom='N30L5nmmCS100S1N4100';
if nargin<3
    ...
    for iG1=1:NiG1
        for iG3=1:NiG3
            for iG4=1:NiG4
                ...
                [iMat,istep]=mln_algorithm(iInput,threshold,kforMF,Fthreshold,methodlog);
...
savestatisfile=[dir,'Sta_',prenom];
